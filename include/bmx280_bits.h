...
#define BMX280_DEFAULT_TEMPERATURE_OVERSAMPLING \
  BMX280_TEMPERATURE_OVERSAMPLING_NONE
...
#define BMX280_DEFAULT_STANDBY BMX280_STANDBY_10M
#else
...
#define BMX280_DEFAULT_CONFIG                                    \
  ((bmx280_config_t){BMX280_DEFAULT_TEMPERATURE_OVERSAMPLING,    \
                     BMX280_DEFAULT_PRESSURE_OVERSAMPLING,       \
                     BMX280_DEFAULT_STANDBY, BMX280_DEFAULT_IIR, \
                     BMX280_DEFAULT_HUMIDITY_OVERSAMPLING})
#else
#define BMX280_DEFAULT_CONFIG                                 \
  ((bmx280_config_t){BMX280_DEFAULT_TEMPERATURE_OVERSAMPLING, \
                     BMX280_DEFAULT_PRESSURE_OVERSAMPLING,    \
